...
(function ($) {
  ...
  $.movingBoxes = function (el, options) {
    ...
    base.init = function () {
      ...
      base.width = document.documentElement.clientWidth;
      ...
      var leftButton = $('.mb-left');
      var rightButton = $('.mb-right');

      $('.current-number').html(counter);
      $('.amount').html(liArr.length);
    ...
    base.returnToNormal = function (num, time) {
      ...
      // Change view for inactive slides
      panels.css({
        height: '1007px',
        filter: 'grayscale(1)',
        ['flex-grow']: 1,
    ...
    base.growBigger = function (num, time, flag) {
      ...
      // Return normal view for active slide
      panels.css({
        height: '1007px',
        filter: 'grayscale(0)',
        ['flex-grow']: 1.5,
