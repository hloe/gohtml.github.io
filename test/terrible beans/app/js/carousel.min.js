...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=467565ffa88e899efe72881b3a18de1e)
 * Config saved to config.json and https://gist.github.com/467565ffa88e899efe72881b3a18de1e
 */
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (t) {
  ...
  i.VERSION = "3.3.7", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
    ...
    if (this.$element.trigger(c), !c.isDefaultPrevented()) {
      ...
      }).emulateTransitionEnd(i.TRANSITION_DURATION)) : (n.removeClass("active"), r.addClass("active"), this.sliding = !1, this.$element.trigger(d)), a && this.cycle(), this
    }
  };
  var s = t.fn.carousel;
